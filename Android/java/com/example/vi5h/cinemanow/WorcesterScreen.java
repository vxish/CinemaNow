...
public class WorcesterScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worcester_screen);
        initPosterBitmaps();
    }
    ...
    private void initRecyclerView(){
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewWorc);
