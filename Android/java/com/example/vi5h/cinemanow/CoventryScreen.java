...
public class CoventryScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coventry_screen);
        initPosterBitmaps();
    }
    ...
    private void initRecyclerView(){
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewCov);
